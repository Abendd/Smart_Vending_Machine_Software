...
def trans():
    window.destroy()
    window1=Tk()
    window1.title('Smart Vending Machine Software ')
    but1 = Button(window1, text='Withdrawn', width=40, height=10,bg='#7cfc00', fg='black', bd=5)
...
def chan():
    ...
    window1 = Tk()
    window1.title('Smart Vending Machine Software ')
    but1 = Button(window1, text='Pin Changed to 1234', width=40, height=10,bg='#7cfc00', fg='black', bd=5)
    but1.grid(row=1, column=1)
    window1.mainloop()
...
def bal():
    ...
    window1 = Tk()
    window1.title('Smart Vending Machine Software ')
    but1 = Button(window1, text='Balance is 1000.01 Cr.', width=40, height=10,bg='#7cfc00', fg='black', bd=5)
    but1.grid(row=1, column=1)
    window1.mainloop()
def EAR(eye):
...
but4 = Button(window, text='Start', width=40, height=10,
              bg='#7cfc00', fg='black', bd=5,command=start)
